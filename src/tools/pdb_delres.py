...
This program is part of the `pdb-tools` suite of utilities. The `pdb-tools` were
created to quickly manipulate PDB files using the terminal, and can be used
sequentially, with one tool streaming data to another.
"""
